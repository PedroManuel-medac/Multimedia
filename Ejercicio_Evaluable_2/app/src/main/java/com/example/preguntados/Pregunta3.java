    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MediaPlayer sonidoIncorrecto = MediaPlayer.create(Pregunta3.this, R.raw.incorrecto);
                sonidoIncorrecto.start();

                b2.setBackgroundTintList(ColorStateList.valueOf(
                        ContextCompat.getColor(Pregunta3.this, R.color.rojo)
                ));
                new Handler(Looper.getMainLooper()).postDelayed(() -> {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Pregunta3.this);
                    builder.setTitle("¡Respuesta incorrecta!");
                    builder.setMessage("La respuesta correcta es --> El escriba ciego");
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                b3.setBackgroundTintList(ColorStateList.valueOf(
                        ContextCompat.getColor(Pregunta3.this, R.color.verde)
                ));

                MediaPlayer sonidoIncorrecto = MediaPlayer.create(Pregunta3.this, R.raw.correcto);
                sonidoIncorrecto.start();
        ...
        String pista3 = "Quien no ve, recuerda por otros medios.";
